...
public class UserArgumentResolver implements HandlerMethodArgumentResolver {
	...
	// * resolverArgument() 메서드가 반환하는 객체가 매개변수로 전달된다
	// * UserArgumentResolver는 요청핸들러 메서드의 매개변수 타입이 User인 변수가 있으면,
	//		세션에서 LOGIN_USER로 등록된 객체를 찾아서 반환한다
	@Override
	public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
		...
		// 해당 매개변수가 필요로 하는 User객체를 세션에서 찾아서 반환
